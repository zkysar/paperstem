...
describe('FilePicker', () => {
  ...
  const fixturePractices: Practice[] = [
    { id: 'p1', title: 'Practice 2026-04-28', folder: '2026/04', stems: ['a','b','c'], driveFolderId: 'd1', referenceStemId: null },
    { id: 'p2', title: 'Practice 2026-04-21', folder: '2026/04', stems: ['a','b'], driveFolderId: 'd2', referenceStemId: null },
    { id: 'p3', title: 'Practice 2026-03-31', folder: '2026/03', stems: ['a'], driveFolderId: null, referenceStemId: null },
  ];
